...
Figure 7 has the highest period while Figure 6 has the lowest period. The frequency in Hertz is about the same in the Spectral Density plots.

\begin{figure}[h!]
    \centering
    \includegraphics[width=0.75\linewidth]{image17.png}
    \caption{Preconfigured Fourier Representation of Signal}
\end{figure}
...
Changing the modulating frequency results in a frequency shift from 10Hz to 15Hz. 
...
The Network Analyzer is more powerful and gives you everything at once, but is more complex

The Unit Step method is simpler but differentiation is sensitive to noise, so the impulse response will be less clean — more jaggedness in that plot compared to the Network Analyzer version.

\begin{figure}[h!]
    \centering
    \includegraphics[width=0.75\linewidth]{image14.png}
    \caption{Output of Network Analyzer}
\end{figure}
...
\begin{figure}[h!]
    ...
    \caption{Magnitude, Phase, and Impulse Using Unit Step}
\end{figure}
